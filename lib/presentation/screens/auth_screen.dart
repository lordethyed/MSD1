      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Visibility(
              visible: _isShowLoginError,
              child: const Text("Неверный пароль или логин!",style: TextStyle(
                color: Colors.red,
              ),),
            ),
            const SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  if(loginController.text.isNotEmpty && passwordController.text.isNotEmpty){
                    ...
                    on DioError catch (e) {
                      if(kDebugMode){
                        if(e.response!.data == '{"error":"Autorization Error"}'){
                          setState(() {
                            _isShowLoginError = true;
                          });
                        }
                        else{
